# Visual Context Offload Human Index

The authoritative pointer map is:
...
All entries in the JSON map are `not_evidence: true`. They are context restoration
pointers, not citations or answer support.
