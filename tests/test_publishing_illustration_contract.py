...
REPO_SKILL = RESEARCH_X / ".agents/skills/research-x-publishing-illustration/SKILL.md"
REPO_CONTRACT = RESEARCH_X / "prompt_contracts/research_x_publishing_illustration_v1.yaml"
